     ...
     <main class="home">
      ...
      <section class="home-event">
        <h1 class="title_space">活動資訊</h1>
         <swiper  :navigation="{ nextEl: '.swiper-button-next', prevEl: '.swiper-button-prev' }" :modules="modules" class="mySwiper" :slidesPerView="3" :spaceBetween="10" :pagination="{
      clickable: true,}" :breakpoints="{ 360:{ slidesPerView:1, spaceBetween: 0, }, 900:{ slidesPerView:2,spaceBetween: 5, },1400:{slidesPerView:3,spaceBetween: 10,} }" >
            <swiper-slide><div class="card">
                <a href="#">
                  <img class="image event_pic" src="../assets/img/e1_calligraphy.png" alt=""/>
                </a>
      ...
      clickable: true,}" :breakpoints="{ 360:{ slidesPerView:1, spaceBetween: 0, }, 900:{ slidesPerView:2,spaceBetween: 5, },1400:{slidesPerView:3,spaceBetween: 10,} }" >
                ...
                <swiper-slide>
                      <div class="card">
                                <a href="#">
                                  <img class="image event_pic" src="../assets/img/p1_cherry.jpg" alt="">
                                </a>
