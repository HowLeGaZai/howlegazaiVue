<template>
    ...
    <div class="popup_l_space">
      ...
      <div class="">
        <h4>取消原因:</h4>
        <br><br>
        <select name="" id="" class="f-select col1">
      ...
      <h5>備註:</h5>
      <br>
      <textarea name="" id="" cols="30" rows="10" style="resize:none" class="f-text" placeholder="回覆討論"></textarea>
      <br><br><br>
      <button type="button" class="btn-m btn-color-green">取消確認</button>
