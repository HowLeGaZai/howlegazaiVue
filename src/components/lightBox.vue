<template>
    ...
    <div class="popup_content">
      ...
      <div class="apply_cancel">
            <div class="lightboxpic" v-if="pic">
              <img :src="pic" alt="">
            </div>
            ...
            <div class="remark">
            <h5>{{ labelTextarea }}</h5>
            <textarea name="" id="" cols="30" rows="10" style="resize:none" class="f-text width70percentage" placeholder="請輸入" v-model="textareaValue"></textarea>
            </div>
          </div>
      <h6>注意事項：<br>{{ note }}</h6>
